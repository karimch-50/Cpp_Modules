...
// 		// int			AttackDamage;
// 	public:
// 		Base(){std::cout << "Base Construcrted" << std::endl;}
...
// 	std::cout << "Size: " << sizeof(base) << std::endl;
// 	return (0);
// }
...
// {
// 	public:
// 		void aria(int a, int b){std::cout << "Value =" << a * b << std::endl;}
// 		void aria(float a, float b){std::cout << "Value2 =" << a * b << std::endl;}
// };
